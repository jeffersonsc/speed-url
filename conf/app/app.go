...
import (
	...
	"github.com/jeffersonsc/speed-url/handler"
	"github.com/jeffersonsc/speed-url/lib/cache"
	"github.com/jeffersonsc/speed-url/lib/context"
	"github.com/jeffersonsc/speed-url/lib/cors"
	"github.com/jeffersonsc/speed-url/lib/template"
	"gopkg.in/macaron.v1"
)
...
func SetupRoutes(app *macaron.Macaron) {
	...
	app.Post("/create", handler.CreateURL)
	app.Get("/:id/expand", handler.ShowURL)
	app.Get("/:id", handler.FindURL)
	/*
